 ...
 *    @param {array} [categories] - optional - Must start start with capital letters
 *
 *    @param {string} [author='L'] - optional - may be supressed
 *    @param {string} [userNote] - optional - may be supressed
 *    @param {string} [devNote] - optional - may be supressed
 *
 * spec
