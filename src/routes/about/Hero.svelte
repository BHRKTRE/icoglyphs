<script>
	let { minSectionHeight } = $props();
</script>

<section style="min-height:{minSectionHeight}" id="hero-section">
	<div class="hero-text-container">
		<h1>Open-Source Ideographic Icon Library</h1>
		<p>
	...
	<!--Sticky button ? -->
	<button>Discover the library</button>
</section>
